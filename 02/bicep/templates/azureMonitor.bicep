...
param applicationInsightsConnectionStringSecretName string = 'applicationInsightsConnectionString'
...
module applicationInsightsConnectionStringSecret './keyVaultSecret.bicep' = {
